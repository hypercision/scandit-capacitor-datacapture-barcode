...
import { BarcodeSelectionFeedback } from './BarcodeSelection+Related';
import { CameraSettings } from '../../../scandit-capacitor-datacapture-core/src/ts/Camera+Related';
import { BarcodeSelectionListenerProxy } from './Capacitor/BarcodeSelectionListenerProxy';
import { BarcodeSelectionProxy } from './Capacitor/BarcodeSelectionProxy';
...
export class BarcodeSelection extends DefaultSerializeable {
    constructor() {
        super(...arguments);
