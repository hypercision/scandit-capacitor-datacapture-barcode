...
import com.scandit.capacitor.datacapture.core.utils.bitmapFromBase64String
        ...
        lock.withLock {
            plugin.notify(
                ...
                JSObject.fromJSONObject(
                    JSONObject(
                        mapOf(
                            NAME to BarcodeCaptureActionFactory.SEND_VIEW_FOR_TRACKED_BARCODE,
        ...
        lock.withLock {
            plugin.notify(
                ...
                JSObject.fromJSONObject(
                    JSONObject(
                        mapOf(
                            NAME to BarcodeCaptureActionFactory.SEND_OFFSET_FOR_TRACKED_BARCODE,
                            FIELD_TRACKED_BARCODE to trackedBarcode.toJson()
                        )
                    )
                )
        ...
        lock.withLock {
            plugin.notify(
                ...
                JSObject.fromJSONObject(
                    JSONObject(
                        mapOf(
                            NAME to BarcodeCaptureActionFactory.SEND_ANCHOR_FOR_TRACKED_BARCODE,
                            FIELD_TRACKED_BARCODE to trackedBarcode.toJson()
                        )
                    )
                )
        ...
        lock.withLock {
            plugin.notify(
                ...
                JSObject.fromJSONObject(
                    JSONObject(
                        mapOf(
                            NAME to BarcodeCaptureActionFactory.SEND_TAP_VIEW_FOR_TRACKED_BARCODE,
                            FIELD_TRACKED_BARCODE to trackedBarcode.toJson()
                        )
                    )
                )
