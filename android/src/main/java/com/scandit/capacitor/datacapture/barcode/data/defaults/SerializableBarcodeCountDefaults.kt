...
data class SerializableBarcodeCountDefaults(
    ...
    override fun toJson(): JSONObject = JSONObject(
        mapOf(
            FIELD_RECOMMENDED_CAMERA_SETTINGS to recommendedCameraSettings,
            FIELD_BARCODE_COUNT_SETTINGS to barcodeCountSettings,
...
data class SerializableBarcodeCountViewDefaults(
    ...
    override fun toJson(): JSONObject = JSONObject(
        mapOf(
            ...
            FIELD_RECOGNIZED_BRUSH to
                SerializableBrushDefaults(BarcodeCountView.defaultRecognizedBrush()).toJson(),
            FIELD_UNRECOGNIZED_BRUSH to
                SerializableBrushDefaults(BarcodeCountView.defaultUnrecognizedBrush()).toJson(),
            FIELD_NOT_IN_LIST_BRUSH to
                SerializableBrushDefaults(BarcodeCountView.defaultNotInListBrush()).toJson(),
            FIELD_SHOULD_SHOW_SCAN_AREA_GUIDES to barcodeCountView.shouldShowScanAreaGuides,
            FIELD_SHOULD_SHOW_SINGLE_SCAN_BUTTON to barcodeCountView.shouldShowSingleScanButton,
            FIELD_SHOULD_SHOW_TOOLBAR to barcodeCountView.shouldShowToolbar,
...
data class SerializableBarcodeCountSettingsDefaults(
...
internal class SerializableBarcodeFilterSettingsDefaults(
    ...
    override fun toJson(): JSONObject = JSONObject(
        mapOf(
            ...
            FIELD_EXCLUDED_SYMBOLOGIES to barcodeFilterSettings.excludedSymbologies
        )
    )
    ...
    override fun toJson(): JSONObject = JSONObject(
        mapOf(
            ...
            FIELD_AUDIO_BUTTON_CONTENT_DESCRIPTION to
                toolbarDefaults.audioButtonContentDescription(
                    context
                ),
            ...
            FIELD_VIBRATION_BUTTON_CONTENT_DESCRIPTION to
                toolbarDefaults.vibrationButtonContentDescription(
                    context
                ),
            ...
            FIELD_STRAP_MODE_BUTTON_CONTENT_DESCRIPTION to
                toolbarDefaults.strapModeButtonContentDescription(
                    context
                ),
            ...
            FIELD_COLOR_SCHEME_BUTTON_CONTENT_DESCRIPTION to
                toolbarDefaults.colorSchemeButtonContentDescription(
                    context
                )
        )
    )
